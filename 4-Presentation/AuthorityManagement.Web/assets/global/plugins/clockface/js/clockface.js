...
(function ($) {
    ...
    Clockface.prototype = {
        ...
        init: function () {
          ...
          this.$clockface.find('http://www.keenthemes.com/preview/metronic/assets/global/plugins/clockface/js/.l1 .cell, .left.cell').html('<div class="outer"></div><div class="inner"></div>'); 
          this.$clockface.find('http://www.keenthemes.com/preview/metronic/assets/global/plugins/clockface/js/.l5 .cell, .right.cell').html('<div class="inner"></div><div class="outer"></div>'); 
          this.$clockface.hide();
