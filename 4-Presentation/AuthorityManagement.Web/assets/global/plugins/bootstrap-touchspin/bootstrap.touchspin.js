    ...
    return this.each(function() {
      ...
      function upOnce() {
        ...
        if (value > settings.max) {
          value = settings.max;
          originalinput.trigger('http://www.keenthemes.com/preview/metronic/assets/global/plugins/bootstrap-touchspin/touchspin.on.max');
          stopSpin();
        }
      ...
      function downOnce() {
        ...
        if (value < settings.min) {
          value = settings.min;
          originalinput.trigger('http://www.keenthemes.com/preview/metronic/assets/global/plugins/bootstrap-touchspin/touchspin.on.min');
          stopSpin();
        }
