var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var countries = new Bloodhound({
          ...
          limit: 10,
          prefetch: {
            url: 'http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/demo/typeahead_countries.json',
        ...
        var custom = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          remote: 'http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/demo/typeahead_custom.php?query=%QUERY'
        });
        ...
        var nba = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/demo/typeahead_nba.json'
        });
         
        var nhl = new Bloodhound({
          datumTokenizer: function(d) { return Bloodhound.tokenizers.whitespace(d.team); },
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/demo/typeahead_nhl.json'
        });
    ...
    var handleInputMasks = function () {
        ...
        $("#mask_currency2").inputmask('http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/€ 999,999,999.99', {
            numericInput: true,
            rightAlignNumerics: false,
            greedy: false
        }); //123456  =>  € ___.__1.234,56
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function (e) {
            ...
            $.post('http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/demo/username_checker.php', {
                username: input.val()
            }, function (res) {
