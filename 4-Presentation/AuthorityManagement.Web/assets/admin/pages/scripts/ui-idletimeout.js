    ...
    return {
        ...
        init: function () {
            ...
            $.idleTimeout('#idle-timeout-dialog', '.modal-content button:last', {
                ...
                keepAliveURL: 'http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/demo/idletimeout_keepalive.php',
                serverResponseEquals: 'OK',
                onTimeout: function(){
                    window.location = "http://www.keenthemes.com/preview/metronic/assets/admin/pages/scripts/extra_lock.html";
                },
                onIdle: function(){
